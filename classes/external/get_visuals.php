        ...
        return new \external_single_structure([
            ...
            'panels' => new \external_multiple_structure(new \external_single_structure([
                ...
                'items' => new \external_multiple_structure(new \external_single_structure([
                    'key' => new \external_value(PARAM_TEXT, 'Optional item key', VALUE_OPTIONAL),
                    ...
                    'start' => new \external_value(PARAM_INT, 'Optional interval start timestamp', VALUE_OPTIONAL),
                    'end' => new \external_value(PARAM_INT, 'Optional interval end timestamp', VALUE_OPTIONAL),
                    'joined' => new \external_value(PARAM_INT, 'Optional staff joined count', VALUE_OPTIONAL),
                    'left' => new \external_value(PARAM_INT, 'Optional staff left count', VALUE_OPTIONAL),
                    'net' => new \external_value(PARAM_INT, 'Optional staff net movement', VALUE_OPTIONAL),
                    'turnover' => new \external_value(PARAM_FLOAT, 'Optional turnover percentage', VALUE_OPTIONAL),
                    'headcount' => new \external_value(PARAM_INT, 'Optional staff headcount', VALUE_OPTIONAL),
                    'maxmovement' => new \external_value(PARAM_INT, 'Optional staff movement chart scale', VALUE_OPTIONAL),
                    'maxrate' => new \external_value(PARAM_FLOAT, 'Optional turnover rate chart scale', VALUE_OPTIONAL),
                    ...
                    ]), 'Optional staff dynamics period KPIs', VALUE_OPTIONAL),
                    'intervalkpis' => new \external_multiple_structure(new \external_single_structure([
                        'key' => new \external_value(PARAM_ALPHANUMEXT, 'KPI key'),
                        'label' => new \external_value(PARAM_TEXT, 'KPI label'),
                        'value' => new \external_value(PARAM_TEXT, 'KPI value'),
                        'status' => new \external_value(PARAM_ALPHANUMEXT, 'KPI status'),
